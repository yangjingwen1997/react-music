...
class Detail2 extends Component{
    ...
    constructor(props){
        ...
        props.dispatch(clear('CLEAR_DETAIL2'));
        props.dispatch(
    ...
    renderPage=({title,detail:{auth,auth_icon,content}})=>(
        <div className='main'>
            <Nav/>
            <div className="content">
                <div className="header clear"><h2>
                    <img width="50" src={`${this.baseUrl2}/${auth_icon}`} alt=""/></h2>
                    <p>{auth}☊</p></div>
                <div className="cont">
                    <h3>{title}<span style={{color:'indianred'}}> ♪♫♮♭♩♬♭</span></h3>
